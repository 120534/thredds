...
public class MockTdsContextLoader extends AbstractContextLoader
{
    ...
    private TdsResourceBasePath tdsResourceBasePath;

    public MockTdsContextLoader() {
        super();
    }
    ...
    public ApplicationContext loadContext(String... locations) throws Exception {
        final MockServletContext servletContext
                = (tdsResourceBasePath == null ? new MockTdsServletContext()
                : new MockTdsServletContext(tdsResourceBasePath.path()));
    ...
    private void extractConfiguration(Class<?> clazz) {
        if(this.tdsContentRootPath == null)
            this.tdsContentRootPath = AnnotationUtils.findAnnotation(clazz, TdsContentRootPath.class);
        if(this.tdsResourceBasePath == null)
            this.tdsResourceBasePath = AnnotationUtils.findAnnotation(clazz, TdsResourceBasePath.class);
    }
}
